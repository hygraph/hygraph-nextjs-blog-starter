          ...
          <dd>
            <ul className="space-x-8 sm:space-x-12 lg:space-x-0 lg:space-y-8">
              <li className="flex space-x-2">
                <Image className="w-10 h-10 rounded-full" src={post.author.picture.url} width={post.author.picture.width} height={post.author.picture.height} alt={post.author.name} />
